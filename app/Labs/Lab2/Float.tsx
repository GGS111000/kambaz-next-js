...
export default function Float() {
    return (
        ...
        <div id="wd-float-divs">
            ...
            <div className="wd-float-left wd-dimension-portrait wd-bg-color-blue">Blue</div>
            <div className="wd-float-left wd-dimension-portrait wd-bg-color-red">Red</div>
                <div>
                <Image className="wd-float-right" alt="image tag" width={150} height={100}
                    src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg"/>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eius hic ...
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eius hic ...
                <Image className="wd-float-left" alt="image tag" width={150} height={100}
                    src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg"/>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eius hic ...
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eius hic ...
                <Image className="wd-float-right" alt="image tag" width={150} height={100}
